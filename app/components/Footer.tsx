...
const Footer = () => {
  return (
    <footer
      id="Footer"
      className="bg-darkViolet py-[50px] lg:pt-[80px] relative"
    >
      <div className="lg:flex w-[75%] mx-auto">
        {/* img */}
        <div>
          <Image
            className="brightness-0 invert-[100%] mx-auto lg:w-[150px]"
            src={"/images/logo.svg"}
            alt=""
            width={121}
            height={33}
      ...
      <div>
        <p className="text-center text-white text-[12px] absolute bottom-2 right-[50%] translate-x-[50%] w-full">
          Frontmentor Challenge. Coded with ♥ by{" "}
          <a
            className="text-primary font-bold"
            href="https://github.com/cindyeme"
            target="_blank"
